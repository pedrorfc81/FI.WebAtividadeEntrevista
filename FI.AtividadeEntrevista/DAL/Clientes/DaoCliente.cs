...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        /// Pesquisa clientes
        /// </summary>
        /// <param name="iniciarEm">Iniciar em</param>
        /// <param name="quantidade">Quantidade</param>
        /// <param name="campoOrdenacao">Campo ordenação</param>
        /// <param name="crescente">Crescente</param>
        ...
        /// <summary>
        /// Converter retorno DataSet para Objeto
        /// </summary>
